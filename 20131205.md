<div>SQLWorld★大阪#19 開催情報</div>\r\n<div>&nbsp;</div>\r\n<div><span style=\"line-height: 21px;\">【日時】</span></div>\r\n<p>
    2013年12月5日（木曜日）　19:00~21:00</p>\r\n<p>【イベント概要】<br />SQLWorld 5回目の平日夜開催～。今回も、みんなで SQL
    を書いてみようというハンズオン企画です！今回は初心者向けの問題多めで開催予定。ブラウザがあれば参加出来るようにしていますので、iPad 等のタブレットでも大丈夫です。</p>\r\n<p>
    ...
    電話(番号は申し込み後リマインダーにて公開)までご連絡ください。</p>\r\n<div>【タイムテーブル】</div>\r\n<table style=\"width: 100%;\" border=\"1\">\r\n
    ...
    Web アプリを用意しました。<br />クエリのネタも募集中です。<br /> スピーカー：SQLWorld お だ</div>\r\n<div>&nbsp;</div>\r\n<p>まとめ：<a
        href=\"http://togetter.com/li/599340\">SQLWorld★大阪#19 まとめ</a></p>\r\n<p><span style=\"text-decoration:
